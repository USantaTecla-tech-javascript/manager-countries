...
let name = `Spain`;
console.writeln(`¿Está el país de nombre ${name}?: ${includes(getCountries(), searchBySpain)}`);
name = `Atlantida`;
console.writeln(`¿Está el país de nombre ${name}?: ${includes(getCountries(), searchByAtlantida)}`);

let capital = `Madrid`;
console.writeln(`¿Está el país de capital ${capital}?: ${includes(getCountries(), searchByMadrid)}`);
capital = `Utopía`;
console.writeln(`¿Está el país de capital ${capital}?: ${includes(getCountries(), searchByUtopia)}`);


function includes(countries, search) {
...
function searchBySpain({ name }){
  return name === `Spain`;
}

function searchByAtlantida({ name }){
  return name === `Atlantida`;
}

function searchByMadrid({ name }){
  return capital === `Madrid`;
}

function searchByUtopia({ name }){
  return capital === `Utopía`;
}
