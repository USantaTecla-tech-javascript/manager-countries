...
let name = `Spain`;
console.writeln(`¿Está el país de nombre ${name}?: ${includes(getCountries(), generateSearchByName(name))}`);
name = `Atlantida`;
console.writeln(`¿Está el país de nombre ${name}?: ${includes(getCountries(), generateSearchByName(name))}`);

let capital = `Madrid`;
console.writeln(`¿Está el país de capital ${capital}?: ${includes(getCountries(), generateSearchByCapital(capital))}`);
capital = `Utopía`;
console.writeln(`¿Está el país de capital ${capital}?: ${includes(getCountries(), generateSearchByCapital(capital))}`);

function generateSearchByName(name){
  function searchByName (countrie){
...
function generateSearchByCapital(capital){
  function searchByCapital(countrie){
    return countrie.capital === capital;
  };

  return searchByCapital;
}
