...
let name = `Spain`;
console.writeln(`Posición de ${name} por nombre: ${indexOfByName(getCountries(), name)}`);
name = `Atlantida`;
console.writeln(`Posición de ${name} por nombre: ${indexOfByName(getCountries(), name)}`);
let capital = `Madrid`;
console.writeln(`Posición de ${capital} por capital: ${indexOfByCapital(getCountries(), capital)}`);
capital = `Utopía`;
console.writeln(`Posición de ${capital} por capital: ${indexOfByCapital(getCountries(), capital)}`);

function indexOfByName(countries, name) {
...
function indexOfByCapital(countries, capital) {
  for (let i=0; i<countries.length; i++) {
