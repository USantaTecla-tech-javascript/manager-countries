...
let name = `Spain`;
console.writeln(`Posición de ${name} por nombre: ${indexOf(getCountries(), generateSearchByName(name))}`);
name = `Atlantida`;
console.writeln(`Posición de ${name} por nombre: ${indexOf(getCountries(), generateSearchByName(name))}`);
let capital = `Madrid`;
console.writeln(`Posición de ${capital} por capital: ${indexOf(getCountries(), generateSearchByCapital(capital))}`);
capital = `Utopía`;
console.writeln(`Posición de ${capital} por capital: ${indexOf(getCountries(), generateSearchByCapital(capital))}`);
