...
let name = `Spain`;
console.writeln(`Posición de ${name} por nombre: ${getCountries().map((countrie) => countrie.name).indexOf(name)}`);
name = `Atlantida`;
console.writeln(`Posición de ${name} por nombre: ${getCountries().map((countrie) => countrie.name).indexOf(name)}`);
let capital = `Madrid`;
console.writeln(`Posición de ${capital} por capital: ${getCountries().map((countrie) => countrie.capital).indexOf(name)}`);
capital = `Utopía`;
console.writeln(`Posición de ${capital} por capital: ${getCountries().map((countrie) => countrie.capital).indexOf(name)}`);
