...
let position = findIndex(getCountries(), (countrie) => countrie.region === `Asia` && countrie.population > 1000000);
console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${position}`);

region = `Americas`;
population = 1000;
position = findIndex(getCountries(), (countrie) => countrie.region === `Americas` && countrie.population > 1000);
console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${position}`);

let subregion = `Northern Europe`;
let area = 100000;
position = findIndex(getCountries(), (countrie) => countrie.subregion === `Northern Europe` && countrie.area > 100000);
console.writeln(`¿Cuál es la posición del primer país de ${subregion} con area superior o igual a ${area}?: ${position}`);

subregion = `Polynesia`;
area = 1000000;
position = findIndex(getCountries(), (countrie) => countrie.subregion === `Polynesia` && countrie.area > 1000000);
console.writeln(`¿Cuál es la posición del primer país de ${subregion} con area superior o igual a ${area}?: ${position}`);
