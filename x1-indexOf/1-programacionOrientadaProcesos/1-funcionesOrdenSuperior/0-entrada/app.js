...
let name = `Spain`;
console.writeln(`Posición de ${name} por nombre: ${indexOf(getCountries(), searchBySpain)}`);
name = `Atlantida`;
console.writeln(`Posición de ${name} por nombre: ${indexOf(getCountries(), searchByAtlantida)}`);

let capital = `Madrid`;
console.writeln(`Posición de ${capital} por capital: ${indexOf(getCountries(), searchByMadrid)}`);
capital = `Utopía`;
console.writeln(`Posición de ${capital} por capital: ${indexOf(getCountries(), searchByUtopia)}`);


function indexOf(countries, search) {
